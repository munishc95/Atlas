...
export default function SettingsPage() {
  ...
  const saveMutation = useMutation({
    mutationFn: async () => {
      const payload = {
        ...
        confidence_gate_enabled: form.confidence_gate_enabled === "true",
        confidence_gate_avg_threshold: Number(form.confidence_gate_avg_threshold),
        confidence_gate_low_symbol_threshold: Number(form.confidence_gate_low_symbol_threshold),
        confidence_gate_low_pct_threshold: Number(form.confidence_gate_low_pct_threshold),
        confidence_gate_fallback_pct_threshold: Number(
          form.confidence_gate_fallback_pct_threshold,
        ),
  ...
  const fields = useMemo(
    () => [
      ...
      { key: "confidence_gate_enabled", label: "Confidence gate enabled (true/false)" },
      { key: "confidence_gate_avg_threshold", label: "Confidence gate avg threshold" },
      {
        key: "confidence_gate_low_symbol_threshold",
        label: "Confidence gate low-symbol threshold",
      },
      { key: "confidence_gate_low_pct_threshold", label: "Confidence gate low-confidence % threshold" },
      { key: "confidence_gate_fallback_pct_threshold", label: "Confidence gate fallback dominance threshold" },
